...
urlpatterns = [
    ...
    path('crear_autodiagnostico/', views.crearAutodiagnosticoApp, name = "crear_autodiagnostico"),
    path('desempeno_usuario/<int:pk>', views.desempeñoApp, name = "desempeno_usuario"),
